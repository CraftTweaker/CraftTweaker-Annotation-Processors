...
import org.openzen.zencode.java.ZenCodeType.Struct;
...
public class StructWrapper {
     ...
     */
    private StructWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Struct.class);
    }
     ...
     */
    private StructWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Struct annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Struct.class) != null;
    }
      ...
      */
    public static StructWrapper wrap(Element element) {
        return isAnnotated(element) ? new StructWrapper(element) : null;
    }
     ...
     */
    public static StructWrapper wrap(AnnotationMirror annotationMirror) {
        return new StructWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static StructWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new StructWrapper(element, annotationMirror);
    }
