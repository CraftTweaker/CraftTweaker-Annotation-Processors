 ...
 */
public class OptionalDoubleWrapper {
     ...
     */
    private OptionalDoubleWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, OptionalDouble.class);
    }
     ...
     */
    private OptionalDoubleWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     */
    public double value() {
        return (double)AnnotationUtils.getAnnotationValueOfAttributeWithDefaults(annotationMirror, "value").getValue();
    }
     ...
     * @return true, if passed element is annotated with OptionalDouble annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(OptionalDouble.class) != null;
    }
      ...
      */
    public static OptionalDoubleWrapper wrap(Element element) {
        return isAnnotated(element) ? new OptionalDoubleWrapper(element) : null;
    }
     ...
     */
    public static OptionalDoubleWrapper wrap(AnnotationMirror annotationMirror) {
        return new OptionalDoubleWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static OptionalDoubleWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new OptionalDoubleWrapper(element, annotationMirror);
    }
