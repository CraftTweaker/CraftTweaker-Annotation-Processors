...
public class MethodWrapper {
     ...
     */
    private MethodWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Method.class);
    }
     ...
     */
    private MethodWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Method annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Method.class) != null;
    }
      ...
      */
    public static MethodWrapper wrap(Element element) {
        return isAnnotated(element) ? new MethodWrapper(element) : null;
    }
     ...
     */
    public static MethodWrapper wrap(AnnotationMirror annotationMirror) {
        return new MethodWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static MethodWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new MethodWrapper(element, annotationMirror);
    }
