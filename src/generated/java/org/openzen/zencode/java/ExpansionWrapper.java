...
public class ExpansionWrapper {
     ...
     */
    private ExpansionWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Expansion.class);
    }
     ...
     */
    private ExpansionWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Expansion annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Expansion.class) != null;
    }
      ...
      */
    public static ExpansionWrapper wrap(Element element) {
        return isAnnotated(element) ? new ExpansionWrapper(element) : null;
    }
     ...
     */
    public static ExpansionWrapper wrap(AnnotationMirror annotationMirror) {
        return new ExpansionWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static ExpansionWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new ExpansionWrapper(element, annotationMirror);
    }
