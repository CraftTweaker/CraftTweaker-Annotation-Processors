...
public class NameWrapper {
     ...
     */
    private NameWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Name.class);
    }
     ...
     */
    private NameWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Name annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Name.class) != null;
    }
      ...
      */
    public static NameWrapper wrap(Element element) {
        return isAnnotated(element) ? new NameWrapper(element) : null;
    }
     ...
     */
    public static NameWrapper wrap(AnnotationMirror annotationMirror) {
        return new NameWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static NameWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new NameWrapper(element, annotationMirror);
    }
