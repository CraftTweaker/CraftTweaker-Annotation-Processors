...
public class UnsignedWrapper {
     ...
     */
    private UnsignedWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Unsigned.class);
    }
     ...
     */
    private UnsignedWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Unsigned annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Unsigned.class) != null;
    }
      ...
      */
    public static UnsignedWrapper wrap(Element element) {
        return isAnnotated(element) ? new UnsignedWrapper(element) : null;
    }
     ...
     */
    public static UnsignedWrapper wrap(AnnotationMirror annotationMirror) {
        return new UnsignedWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static UnsignedWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new UnsignedWrapper(element, annotationMirror);
    }
