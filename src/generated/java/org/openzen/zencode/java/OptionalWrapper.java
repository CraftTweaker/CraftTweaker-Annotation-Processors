...
public class OptionalWrapper {
     ...
     */
    private OptionalWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Optional.class);
    }
     ...
     */
    private OptionalWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Optional annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Optional.class) != null;
    }
      ...
      */
    public static OptionalWrapper wrap(Element element) {
        return isAnnotated(element) ? new OptionalWrapper(element) : null;
    }
     ...
     */
    public static OptionalWrapper wrap(AnnotationMirror annotationMirror) {
        return new OptionalWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static OptionalWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new OptionalWrapper(element, annotationMirror);
    }
