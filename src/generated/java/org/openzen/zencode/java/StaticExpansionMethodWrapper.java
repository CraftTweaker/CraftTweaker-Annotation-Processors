 ...
 */
public class StaticExpansionMethodWrapper {
     ...
     */
    private StaticExpansionMethodWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, StaticExpansionMethod.class);
    }
     ...
     */
    private StaticExpansionMethodWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with StaticExpansionMethod annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(StaticExpansionMethod.class) != null;
    }
      ...
      */
    public static StaticExpansionMethodWrapper wrap(Element element) {
        return isAnnotated(element) ? new StaticExpansionMethodWrapper(element) : null;
    }
     ...
     */
    public static StaticExpansionMethodWrapper wrap(AnnotationMirror annotationMirror) {
        return new StaticExpansionMethodWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static StaticExpansionMethodWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new StaticExpansionMethodWrapper(element, annotationMirror);
    }
