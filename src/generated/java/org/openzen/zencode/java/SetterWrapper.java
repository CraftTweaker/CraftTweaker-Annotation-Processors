...
public class SetterWrapper {
     ...
     */
    private SetterWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Setter.class);
    }
     ...
     */
    private SetterWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Setter annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Setter.class) != null;
    }
      ...
      */
    public static SetterWrapper wrap(Element element) {
        return isAnnotated(element) ? new SetterWrapper(element) : null;
    }
     ...
     */
    public static SetterWrapper wrap(AnnotationMirror annotationMirror) {
        return new SetterWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static SetterWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new SetterWrapper(element, annotationMirror);
    }
