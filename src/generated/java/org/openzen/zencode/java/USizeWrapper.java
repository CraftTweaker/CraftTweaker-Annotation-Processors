...
import org.openzen.zencode.java.ZenCodeType.USize;
...
public class USizeWrapper {
     ...
     */
    private USizeWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, USize.class);
    }
     ...
     */
    private USizeWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with USize annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(USize.class) != null;
    }
      ...
      */
    public static USizeWrapper wrap(Element element) {
        return isAnnotated(element) ? new USizeWrapper(element) : null;
    }
     ...
     */
    public static USizeWrapper wrap(AnnotationMirror annotationMirror) {
        return new USizeWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static USizeWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new USizeWrapper(element, annotationMirror);
    }
