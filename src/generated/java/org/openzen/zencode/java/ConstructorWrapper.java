...
public class ConstructorWrapper {
     ...
     */
    private ConstructorWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Constructor.class);
    }
     ...
     */
    private ConstructorWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Constructor annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Constructor.class) != null;
    }
      ...
      */
    public static ConstructorWrapper wrap(Element element) {
        return isAnnotated(element) ? new ConstructorWrapper(element) : null;
    }
     ...
     */
    public static ConstructorWrapper wrap(AnnotationMirror annotationMirror) {
        return new ConstructorWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static ConstructorWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new ConstructorWrapper(element, annotationMirror);
    }
