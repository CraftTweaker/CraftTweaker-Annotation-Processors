...
import org.openzen.zencode.java.ZenCodeType.NullableUSize;
 ...
 */
public class NullableUSizeWrapper {
     ...
     */
    private NullableUSizeWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, NullableUSize.class);
    }
     ...
     */
    private NullableUSizeWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with NullableUSize annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(NullableUSize.class) != null;
    }
      ...
      */
    public static NullableUSizeWrapper wrap(Element element) {
        return isAnnotated(element) ? new NullableUSizeWrapper(element) : null;
    }
     ...
     */
    public static NullableUSizeWrapper wrap(AnnotationMirror annotationMirror) {
        return new NullableUSizeWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static NullableUSizeWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new NullableUSizeWrapper(element, annotationMirror);
    }
