...
import org.openzen.zencode.java.ZenCodeType.BorrowForCall;
 ...
 */
public class BorrowForCallWrapper {
     ...
     */
    private BorrowForCallWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, BorrowForCall.class);
    }
     ...
     */
    private BorrowForCallWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with BorrowForCall annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(BorrowForCall.class) != null;
    }
      ...
      */
    public static BorrowForCallWrapper wrap(Element element) {
        return isAnnotated(element) ? new BorrowForCallWrapper(element) : null;
    }
     ...
     */
    public static BorrowForCallWrapper wrap(AnnotationMirror annotationMirror) {
        return new BorrowForCallWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static BorrowForCallWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new BorrowForCallWrapper(element, annotationMirror);
    }
