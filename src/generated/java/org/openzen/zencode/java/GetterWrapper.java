...
public class GetterWrapper {
     ...
     */
    private GetterWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Getter.class);
    }
     ...
     */
    private GetterWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Getter annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Getter.class) != null;
    }
      ...
      */
    public static GetterWrapper wrap(Element element) {
        return isAnnotated(element) ? new GetterWrapper(element) : null;
    }
     ...
     */
    public static GetterWrapper wrap(AnnotationMirror annotationMirror) {
        return new GetterWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static GetterWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new GetterWrapper(element, annotationMirror);
    }
