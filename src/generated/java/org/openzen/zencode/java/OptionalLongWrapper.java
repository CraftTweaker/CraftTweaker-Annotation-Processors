...
import org.openzen.zencode.java.ZenCodeType.OptionalLong;
 ...
 */
public class OptionalLongWrapper {
     ...
     */
    private OptionalLongWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, OptionalLong.class);
    }
     ...
     */
    private OptionalLongWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     */
    public long value() {
        return (long)AnnotationUtils.getAnnotationValueOfAttributeWithDefaults(annotationMirror, "value").getValue();
    }
     ...
     * @return true, if passed element is annotated with OptionalLong annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(OptionalLong.class) != null;
    }
      ...
      */
    public static OptionalLongWrapper wrap(Element element) {
        return isAnnotated(element) ? new OptionalLongWrapper(element) : null;
    }
     ...
     */
    public static OptionalLongWrapper wrap(AnnotationMirror annotationMirror) {
        return new OptionalLongWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static OptionalLongWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new OptionalLongWrapper(element, annotationMirror);
    }
