...
import org.openzen.zencode.java.ZenCodeType.BorrowForThis;
 ...
 */
public class BorrowForThisWrapper {
     ...
     */
    private BorrowForThisWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, BorrowForThis.class);
    }
     ...
     */
    private BorrowForThisWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with BorrowForThis annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(BorrowForThis.class) != null;
    }
      ...
      */
    public static BorrowForThisWrapper wrap(Element element) {
        return isAnnotated(element) ? new BorrowForThisWrapper(element) : null;
    }
     ...
     */
    public static BorrowForThisWrapper wrap(AnnotationMirror annotationMirror) {
        return new BorrowForThisWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static BorrowForThisWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new BorrowForThisWrapper(element, annotationMirror);
    }
