...
public class NullableWrapper {
     ...
     */
    private NullableWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Nullable.class);
    }
     ...
     */
    private NullableWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Nullable annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Nullable.class) != null;
    }
      ...
      */
    public static NullableWrapper wrap(Element element) {
        return isAnnotated(element) ? new NullableWrapper(element) : null;
    }
     ...
     */
    public static NullableWrapper wrap(AnnotationMirror annotationMirror) {
        return new NullableWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static NullableWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new NullableWrapper(element, annotationMirror);
    }
