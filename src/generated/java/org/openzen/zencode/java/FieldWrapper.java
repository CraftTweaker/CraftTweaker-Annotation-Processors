...
public class FieldWrapper {
     ...
     */
    private FieldWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Field.class);
    }
     ...
     */
    private FieldWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Field annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Field.class) != null;
    }
      ...
      */
    public static FieldWrapper wrap(Element element) {
        return isAnnotated(element) ? new FieldWrapper(element) : null;
    }
     ...
     */
    public static FieldWrapper wrap(AnnotationMirror annotationMirror) {
        return new FieldWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static FieldWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new FieldWrapper(element, annotationMirror);
    }
