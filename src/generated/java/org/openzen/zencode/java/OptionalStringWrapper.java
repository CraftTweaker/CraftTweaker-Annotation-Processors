 ...
 */
public class OptionalStringWrapper {
     ...
     */
    private OptionalStringWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, OptionalString.class);
    }
     ...
     */
    private OptionalStringWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with OptionalString annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(OptionalString.class) != null;
    }
      ...
      */
    public static OptionalStringWrapper wrap(Element element) {
        return isAnnotated(element) ? new OptionalStringWrapper(element) : null;
    }
     ...
     */
    public static OptionalStringWrapper wrap(AnnotationMirror annotationMirror) {
        return new OptionalStringWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static OptionalStringWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new OptionalStringWrapper(element, annotationMirror);
    }
