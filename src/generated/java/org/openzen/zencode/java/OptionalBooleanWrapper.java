 ...
 */
public class OptionalBooleanWrapper {
     ...
     */
    private OptionalBooleanWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, OptionalBoolean.class);
    }
     ...
     */
    private OptionalBooleanWrapper (Element element, AnnotationMirror annotationMirror) {
    ...
    public boolean value() {
        return (boolean)AnnotationUtils.getAnnotationValueOfAttributeWithDefaults(annotationMirror, "value").getValue();
    }
     ...
     * @return true, if passed element is annotated with OptionalBoolean annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(OptionalBoolean.class) != null;
    }
      ...
      */
    public static OptionalBooleanWrapper wrap(Element element) {
        return isAnnotated(element) ? new OptionalBooleanWrapper(element) : null;
    }
     ...
     */
    public static OptionalBooleanWrapper wrap(AnnotationMirror annotationMirror) {
        return new OptionalBooleanWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static OptionalBooleanWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new OptionalBooleanWrapper(element, annotationMirror);
    }
