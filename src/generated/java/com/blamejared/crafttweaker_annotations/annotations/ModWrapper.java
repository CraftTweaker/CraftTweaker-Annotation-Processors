...
public class ModWrapper {
     ...
     */
    private ModWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Mod.class);
    }
     ...
     */
    public String modid() {
        return (String)AnnotationUtils.getAnnotationValueOfAttributeWithDefaults(annotationMirror, "modid").getValue();
    }
    ...
    public String displayName() {
        return (String)AnnotationUtils.getAnnotationValueOfAttributeWithDefaults(annotationMirror, "displayName").getValue();
    }
     ...
     */
    public String url() {
        return (String)AnnotationUtils.getAnnotationValueOfAttributeWithDefaults(annotationMirror, "url").getValue();
    }
     ...
     * @return true, if passed element is annotated with Mod annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Mod.class) != null;
    }
    ...
    public static ModWrapper wrap(Element element) {
        return isAnnotated(element) ? new ModWrapper(element) : null;
    }
