...
public class PreprocessorWrapper {
     ...
     */
    private PreprocessorWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Preprocessor.class);
    }
     ...
     */
    private PreprocessorWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Preprocessor annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Preprocessor.class) != null;
    }
      ...
      */
    public static PreprocessorWrapper wrap(Element element) {
        return isAnnotated(element) ? new PreprocessorWrapper(element) : null;
    }
     ...
     */
    public static PreprocessorWrapper wrap(AnnotationMirror annotationMirror) {
        return new PreprocessorWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static PreprocessorWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new PreprocessorWrapper(element, annotationMirror);
    }
