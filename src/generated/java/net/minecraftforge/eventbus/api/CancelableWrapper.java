 ...
 */
public class CancelableWrapper {
     ...
     */
    private CancelableWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, Cancelable.class);
    }
     ...
     */
    private CancelableWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with Cancelable annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(Cancelable.class) != null;
    }
      ...
      */
    public static CancelableWrapper wrap(Element element) {
        return isAnnotated(element) ? new CancelableWrapper(element) : null;
    }
     ...
     */
    public static CancelableWrapper wrap(AnnotationMirror annotationMirror) {
        return new CancelableWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static CancelableWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new CancelableWrapper(element, annotationMirror);
    }
