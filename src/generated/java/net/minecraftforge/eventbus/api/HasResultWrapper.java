...
public class HasResultWrapper {
     ...
     */
    private HasResultWrapper (Element annotatedElement) {
        this.annotatedElement = annotatedElement;
        this.annotationMirror = AnnotationUtils.getAnnotationMirror(annotatedElement, HasResult.class);
    }
     ...
     */
    private HasResultWrapper (Element element, AnnotationMirror annotationMirror) {
     ...
     * @return true, if passed element is annotated with HasResult annotation, otherwise false
     */
    public static boolean isAnnotated(Element element) {
        return element != null && element.getAnnotation(HasResult.class) != null;
    }
      ...
      */
    public static HasResultWrapper wrap(Element element) {
        return isAnnotated(element) ? new HasResultWrapper(element) : null;
    }
     ...
     */
    public static HasResultWrapper wrap(AnnotationMirror annotationMirror) {
        return new HasResultWrapper(null, annotationMirror);
    }
   ...
   /**
     ...
     * @return The wrapper instance
     */
    public static HasResultWrapper wrap(Element element, AnnotationMirror annotationMirror) {
        return new HasResultWrapper(element, annotationMirror);
    }
