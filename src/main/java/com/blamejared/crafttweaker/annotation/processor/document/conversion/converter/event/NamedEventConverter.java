...
import com.blamejared.crafttweaker.annotation.processor.document.page.page.EventPage;
...
public class NamedEventConverter extends DocumentConverter {
    ...
    public boolean canConvert(TypeElement typeElement) {
        ...
        return typeElement.getAnnotation(ZenCodeType.Name.class) != null && ZenEventWrapper.isAnnotated(typeElement);
    }
    ...
    public DocumentationPage convert(TypeElement typeElement, DocumentationPageInfo pageInfo) {
        ...
        return new EventPage(typePageInfo, virtualMembers, superType, implementations, staticMembers, genericParameters);
    }
