...
import com.blamejared.crafttweaker.annotation.processor.document.page.member.static_member.BracketExpressionStaticMethodMember;
...
public class NamedTypeStaticMethodConverter extends AbstractEnclosedElementConverter<DocumentedStaticMembers> {
    ...
    private boolean isBEPMethod(ExecutableElement method) {
        ...
        return annotationMirrorUtil.isAnnotationPresentOn(method, BracketResolver.class);
    }
    ...
    private String getBepName(ExecutableElement method) {
        ...
        final AnnotationMirror mirror = annotationMirrorUtil.getMirror(method, BracketResolver.class);
